@inject('UploaderPresenter','Ikodota\Yeoman\Presenters\UploaderPresenter')
...
<style>
    ...
    #uploader .placeholder {
        ...
        padding-top: 178px;
        text-align: center;
        background: url(/img/webuploader/image.png) center 93px no-repeat;
        color: #cccccc;
        font-size: 18px;
        position: relative;
    }
    ...
    function initwebuploader()
    {
        jQuery(function() {
            ...
            uploader = WebUploader.create({
                ...
                server: '{{ $UploaderPresenter->getUploadServer() }}',
                fileNumLimit: 300,
