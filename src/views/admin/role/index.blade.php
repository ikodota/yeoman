        ...
        <div class="col-md-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <p>角色列表及编辑等操作</p>
                    <a href="{{route('admin.role.create')}}" class="btn btn-success">创建角色</a>
                    <!-- start project list -->
                        ...
                        <tr>
                            ...
                            <td>
                                @if($role->name != 'super_admin')
                                    <a href="{{route('admin.role.show',$role->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-key"></i> Permissions </a>

                                    <a href="{{route('admin.role.edit',$role->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                    <a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#defalutModal" data-url="{{ route('admin.role.destroy',$role->id) }}">
